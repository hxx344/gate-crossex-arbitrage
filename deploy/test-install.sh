...
[[ "$(read_setting DATA_DIR /var/lib/gate-crossex-arbitrage)" == /var/lib/gate-crossex-arbitrage ]]
[[ "$(health_url 0.0.0.0 3200)" == http://127.0.0.1:3200/api/health ]]
[[ "$(health_url :: 3200)" == http://\[::1\]:3200/api/health ]]
[[ "$(health_url ::1 3200)" == http://\[::1\]:3200/api/health ]]
...
grep -q '^restart gate-crossex-arbitrage$' "$test_root/systemctl.calls"
